...
import torch
from isaaclab_tasks.manager_based.locomotion.velocity.config.g1.agents.np3o.on_policy_runner import NP3ORunner
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    print("\n[NP3O DEBUG] Using np3o_train.py (custom entry point)\n")
    ...
    print("[NP3O DEBUG] About to construct RSL-RL runner:", agent_cfg.class_name)
